...
const DefaultBadges = () => {
  return (
    ...
    >
      <h1>
        h1.Example heading{" "}
        <span className="badge bg-secondary-subtle text-secondary">New</span>
      </h1>
      <h2>
  ...
  return (
    ...
    >
      ...
      <p className="text-muted">
        Use the <code>.badgesoft--*</code> modifier class to make badges
        lighten.
      </p>
      ...
      <span className="badge me-1 badge-soft-warning rounded-pill">
        Warning
      </span>
...
const PillBadges = () => {
  return (
    ...
    >
      ...
      <h5 className="mt-4">Lighten Badges</h5>
      <p className="text-muted">
        Using the <code>.badgesoft--*</code> modifier class, you can have more
        soften variation.
      </p>
