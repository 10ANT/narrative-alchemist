    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          <code className="me-1">.d-block</code>
          and <code>.img-fluid</code> on carousel images to prevent browser
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          change the amount of time to delay between automatically cycling to
          the next item.
        </>
      }
    >
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          compared to their default white fill with the <code>filter</code> CSS
