    ...
    >
      <p className="muted mb-0">
        ...
        <OverlayTrigger
          placement="top"
          overlay={
            <Tooltip className="danger-tooltip">Default tooltip</Tooltip>
          }
        >
        ...
        letterpress vegan messenger bag stumptown. Farm-to-table Photo booth
        beard seitan, mcsweeney&apos;s fixie sustainable quinoa 8-bit american
        apparel &nbsp;
        <OverlayTrigger
          placement="top"
          overlay={
            <Tooltip className="danger-tooltip">Another tooltip</Tooltip>
          }
        >
        ...
        <OverlayTrigger
          placement="top"
          overlay={
            <Tooltip className="danger-tooltip">Another one here too</Tooltip>
          }
        >
        ...
        <OverlayTrigger
          placement="top"
          overlay={<Tooltip className="danger-tooltip">The last tip!</Tooltip>}
        >
          <a href="#" data-bs-toggle="tooltip" data-bs-title="">
            twitter handle
          </a>
  ...
  return (
    ...
    >
      <OverlayTrigger
        trigger={"hover"}
        placement="top"
        overlay={<Tooltip>Hover Only, Not a Focus</Tooltip>}
      >
        <button
  ...
  return (
    ...
    >
      <div className="d-flex flex-wrap gap-2">
        <OverlayTrigger
          overlay={
            <Tooltip className="primary-tooltip">Tooltip on top</Tooltip>
          }
        >
          <button
            type="button"
        ...
        <OverlayTrigger
          placement="bottom"
          overlay={
            <Tooltip className="danger-tooltip">Tooltip on bottom</Tooltip>
          }
        >
          <button
            type="button"
        ...
        <OverlayTrigger
          placement="left"
          overlay={
            <Tooltip className="danger-tooltip">Tooltip on left</Tooltip>
          }
        >
          <button
            type="button"
        ...
        <OverlayTrigger
          placement="right"
          overlay={
            <Tooltip className="danger-tooltip">Tooltip on right</Tooltip>
          }
        >
          <button
            type="button"
...
const HTMLTags = () => {
  return (
    <ComponentContainerCard
      title="HTML Tags"
      description={<>And with custom HTML added:</>}
    >
      <OverlayTrigger
        placement="top"
        overlay={
