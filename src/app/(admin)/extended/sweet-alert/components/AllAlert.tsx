      ...
      <Row>
        <Col lg={6}>
          <ComponentContainerCard
            ...
            description={<>Here&apos;s a basic example of SweetAlert.</>}
          >
            <button
              type="button"
        ...
        <Col lg={6}>
          <ComponentContainerCard
            title="Long Content"
            description={<>A modal window with a long content inside.</>}
          >
            <button
              type="button"
        ...
        <Col lg={6}>
          <ComponentContainerCard
            title="With Image Header (Logo)"
            description={<>A message with custom Image Header.</>}
          >
            <button
              type="button"
              id="sweetalert-image"
        ...
        <Col lg={6}>
          <ComponentContainerCard
            title="Auto Close"
            description={<>A message with auto close timer.</>}
          >
            <button
              type="button"
              id="sweetalert-close"
        ...
        <Col lg={6}>
          <ComponentContainerCard
            title="Ajax Request"
            description={<>Ajax request example.</>}
          >
            <button
              type="button"
              id="ajax-alert"
