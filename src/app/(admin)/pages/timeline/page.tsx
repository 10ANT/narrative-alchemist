                  ...
                  <div className="mb-2">
                    <div className="d-flex justify-content-between">
                      <p className="mb-2 text-dark fw-semibold fs-16">
                        Project Completed: Achievements and Outcomes
                      </p>
                    ...
                    <p className="mb-1">
                      ...
                      />
                      Successfully met all project goals and objectives within
              ...
              <div className="timeline-desk">
                <div className="timeline-box">
                  ...
                  <p className="mb-2 text-dark fw-semibold fs-16 my-3">
                    Join as a full stack developers
                  </p>
              ...
              <div className="timeline-desk">
                <div className="timeline-box">
                  ...
                  <div className="">
                    ...
                    <p className="mb-0">
                      I&apos;ve come across your posts and found some favorable
                      deals on your page. I&apos;ve added a load of products to
                      the cart and I don&apos;t know the payment options you
                      avail. Also, can you enlighten me about any discount
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="timeline-box">
                  ...
                  <div className="">
                    ...
                    <p className="mb-0">
                      ...
                      needs of our users. We are excited about the future and
                      are dedicated to reaching new heights, expanding our
                      offerings, and maintaining the high standards that have
                      earned us this success
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <div className="d-flex align-items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-muted fw-medium fs-14 mt-1 mb-0">
                          <span className="text-dark">Name : </span> AdminTo
                        </p>
                      </div>
                    </div>
                    <p className="mb-0 mt-2">
                      Creating a simple Bootstrap website involves using the
                      Bootstrap framework to style and layout your HTML
                      content.{" "}
                    </p>
                  </div>
                </div>
