                    ...
                    <Card>
                      <CardBody className="py-4">
                        ...
                        <p className="text-muted mb-0">
                          ...
                          with our website, including the admin panel. Our team
                          is working diligently to resolve the issue and restore
                  ...
                  <Col md={4}>
                    <Card>
                      <CardBody className="py-4">
                        ...
                        <p className="text-muted mb-0">
                          We are currently experiencing unexpected downtime, and
                          some services, including the admin panel, may be
                          temporarily unavailable. Our technical team is
                          actively working to resolve the issue and restore
                  ...
                  <Col md={4}>
                    <Card>
                      <CardBody className="py-4">
                        ...
                        <p className="text-muted mb-0">
                          If you need assistance or have urgent concerns, please
                          contact our support team at{" "}
                          <a href="mailto:#" className="link-info">
                            no-reply@domain.com
                          </a>{" "}
                          or [+12 3456 789]. We apologize for the inconvenience
